...
var ng_tooltip_1 = require("../shared/ng-tooltip");
    ...
    AssetEditor.prototype.saveAsset = function (name, description) {
        ...
        this.assetService.saveItem(this.currentAsset)
            ...
            if (res && res.changes) {
                ...
                _this.tooltipSave = { message: 'Content saved on server', tooltip_class: 'btn-success' };
                ...
                _this.tooltipSave = { message: 'Error processing layout', tooltip_class: 'btn-danger' };
                _this.isInProgress = false;
            }
        }, function (error) {
            _this.currentAsset.label = oldName;
            _this.currentAsset.description = oldDescription;
            _this.tooltipSave = { message: 'Error processing Asset', tooltip_class: 'btn-danger' };
            _this.isInProgress = false;
